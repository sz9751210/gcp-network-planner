                        ...
                        return (
                           <tr key={`${route.projectId}-${route.id}`} className="hover:bg-slate-700/30 transition-colors">
                              ...
                              <td className="px-6 py-4">
                                 <span className={`inline-flex items-center px-2 py-0.5 rounded text-[10px] font-bold border ${type === 'PEERING' ? 'bg-purple-900/30 text-purple-300 border-purple-800' :
